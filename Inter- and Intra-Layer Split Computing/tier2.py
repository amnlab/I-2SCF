...
if(0 not in central_node.Tier_[2]):
    print("======================================================================================")
    print("Inter-Intra Tier 3 Execute")
    print("======================================================================================")
    ...
    for i in range(start_Layer2, end_Layer2 + 1):
        print(" ")
        print("layer ", i)
        split_point1 = central_node.Node_[2][i - (tier1.end_Layer1 + 1)][0] #[TierNum][layerNum][nodeNum]
        split_point2 = central_node.Node_[2][i - (tier1.end_Layer1 + 1)][0] + central_node.Node_[2][i - (tier1.end_Layer1 + 1)][1] #[TierNum][layerNum][nodeNum]
    ...
    for i in range(start_Layer2 - start_Layer2, end_Layer2 - start_Layer2 + 1):
        if check[i] == True:   
            ...
            inference_Latency0 = round(central_node.F_l[i + start_Layer2 - 1]/(central_node.power[2][0] + central_node.power[2][1] + central_node.power[2][2])) + round(central_node.padding[i + start_Layer2 - 1] / central_node.power[2][0])
            
            inference_Latency1 = round(central_node.F_l[i + start_Layer2 - 1]/(central_node.power[2][0] + central_node.power[2][1] + central_node.power[2][2])) + round(central_node.padding[i + start_Layer2 - 1] / central_node.power[2][1])
            
            inference_Latency2 = round(central_node.F_l[i + start_Layer2 - 1]/(central_node.power[2][0] + central_node.power[2][1] + central_node.power[2][2])) + round(central_node.padding[i + start_Layer2 - 1] / central_node.power[2][2])
